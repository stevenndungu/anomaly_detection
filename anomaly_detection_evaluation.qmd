...
We obtain the 32 sets of train and test descriptors based on the following set of hyperparameters search space:
...
Each row represents a unique combination of LOF hyperparameters, and every column represents the results yielded by each of the 32 set of descriptors. 
...
: Distribution of the data set across training, validation and test sets for each galaxy type. The 90^β^ represents the synthetic galaxies generated for validation. {#tbl-dataset-distribution}
:::
